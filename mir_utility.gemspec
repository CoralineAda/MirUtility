...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG", "lib/mir_utility.rb", "README.rdoc", "TODO.txt"]
  s.files = ["CHANGELOG", "History.txt", "init.rb", "lib/mir_utility.rb", "Manifest", "mir_utility.gemspec", "Rakefile", "README.rdoc", "spec/lib/mir_utility_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "TODO.txt"]
